        ...
        <div className="contact__content md:w-auto w-[370px]">
          ...
          <div className="contact__info md:w-auto w-[370px]">
            <div className="contact__card md:w-auto w-[370px]">
              ...
              <span className="contact__card-data">mdabujayed2006@gmail.com</span>

              <a href="mailto:mdabujayed2006@gmail.com" className="contact__button">
                write me
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">0140-6199-567</span>

              <a href="https://api.whatsapp.com/send?phone=01406199567&text=hello,more information!" className="contact__button">
                write me
                <i className='contact__button-icon'>
                  <box-icon name='right-arrow-alt'></box-icon>
                </i>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">facebook/aj</span>

              <a href="https://m.me/abujayedmaj" className="contact__button">
                write me
                <i className='contact__button-icon'>
                  <box-icon name='right-arrow-alt'></box-icon>
                </i>
